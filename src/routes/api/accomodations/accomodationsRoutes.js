...
const { createAccomodation, getAccomodationsBylocation, updatableFields, deleteAccomodations, getAccomodations, updateAccomodation } = accomodationController;
...
router.delete('/:accomodation', isAuthenticated, allowedRoles([2]), validate.checkAcommodation, deleteAccomodations);
router.patch('/:accomodation', isAuthenticated, allowedRoles([2]), fileUploader.any(), validate.accomodationUpdate, validate.checkAcommodation, updatableFields, updateAccomodation);
